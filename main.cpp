...
int main() {
	...
	ui.buttons.push_back(button([&]() { print(Generation, getObjectById(ui.text, "Gen_Text")); }, renderer, "Generation_Button", "TEST", font, "OpenSans-ExtraBold.ttf",
		1700, 970, 150.0, 75.0, 45, { 255, 66, 66, 255 }, { 255, 88, 88, 255 }, { 255, 125, 125, 255 }, { 255, 255, 255, 255 }, 12));
	ui.text.push_back(textBox(renderer, "outtext", font, "OpenSans-ExtraBold.ttf", 250, 250, " ", { 255,255,255,255 }));
	ui.inputs.push_back(textInput([&]() {getObjectById(ui.text, "outtext")->setText(getObjectById(ui.inputs, "inputtest")->typed); }, renderer, "inputtest", "test", font2, "OpenSans.ttf", 100, 100, 200, 40, 20, { 100, 100, 100, 100 }, { 60, 60, 60, 100 }, { 255, 255, 255, 255 }, 10.0, 7, false));
